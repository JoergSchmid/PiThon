...
def test_users_can_query_digits_independently(client):
    ...
    client.get("/pi")
    client.get("/pi")
    assert client.get("/pi/get/joerg").data == b"3.141592653"
    assert client.get("/pi/get/joerg").data == b"5897932384"
    client.delete("/pi/joerg")
    assert client.get("/pi/get/joerg").data == b"3.141592653"
    assert client.get("/pi/get/felix").data == b"3.141592653"
...
def test_get_special_options(client):
    ...
    client.get("/pi")
    assert client.get("/pi/get/getfile").data == b"3.141592653"
